...
export default function MobileResume({ products, deliveryPrice, productsPrice, total }: {
  ...
  return (
    <div className="md:hidden border p-2 rounded-lg overflow-hidden">
      <Button variant="outline" className="w-full drop-shadow-sm justify-between text-base font-bold"
          ...
          >
            ...
            <div className="flex flex-col gap-2 pb-2 px-1">
              <div className="flex justify-between font-bold">
                <h2>Subtotal <span className="text-muted-foreground text-xs">{products.length}x produto(s)</span></h2>
                <h2>{productsPrice}</h2>
              </div>
              <div className="flex justify-between font-bold">
