...
export default function ModeToggle({...props}: React.HTMLAttributes<HTMLDivElement>) {
  const { setTheme } = useTheme()

  return (
    <Button variant="outline" size="icon" onClick={() => document.documentElement.classList.contains("dark") ? setTheme("light") : setTheme("dark")} className={`group ${props.className}`}>
